...
| Profile & projects  | Replace `public/images/profile/profile.jpg` and `public/images/projects/project-*.svg` keeping the filenames (or update the paths in `src/data/projects.ts` / `Hero.tsx`). |
